...
const parseRange = (totalSize, rangeVal) => {
...
const createContentRange = (start, end, total) =>
    `bytes ${start}-${end}/${total}`

const getFileStream = (opts = {}) =>
    fs.createReadStream(`${__dirname}/static/test-vid.mp4`, opts)
